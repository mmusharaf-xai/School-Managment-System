...
export const initDb = async () => {
  ...
  try {
    ...
    await database.run('CREATE TABLE IF NOT EXISTS schools (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL UNIQUE, address TEXT NOT NULL UNIQUE, owner_name TEXT, phone_number TEXT, email TEXT, logo TEXT, description TEXT, code TEXT NOT NULL UNIQUE, created_by INTEGER NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)');
    ...
    const migrations = [
      ...
      'ALTER TABLE schools ADD COLUMN phone_number TEXT',
